 ...
 */
class getShoperControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\ShoperController' shared autowired service.
     *
     * @return \App\Controller\ShoperController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/ShoperController.php';

        $container->services['App\\Controller\\ShoperController'] = $instance = new \App\Controller\ShoperController();
        ...
        ]))->withContext('App\\Controller\\ShoperController', $container));
